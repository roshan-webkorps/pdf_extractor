      ...
      def self.build
        <<~PROMPT
          ...
          **Header Fields (same for all line items in a PO):**
          ...
          - "buyer_delivery_date": Extract from "Transfer date:" field in DD-MM-YYYY format, the date is in MM/DD/YYYY, convert to DD-MM-YYYY (e.g., "11/19/25" -> "19-11-2025")
          - "oc_delivery_date": Extract from "Transfer date:" field in DD-MM-YYYY format, the date is in MM/DD/YYYY, convert to DD-MM-YYYY and subtract 21 days (e.g., "11/19/25" -> "29-10-2025")
