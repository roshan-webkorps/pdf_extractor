  ...
  module SuperdryAustralia
    class Mapper
      def self.build_excel_row(header, line_item)
        {
          "factory" => nil,
          "ship_under_po_ref" => header["purchase_order_number"] || nil,
          "article" => nil,
          ...
          "payment_terms" => "TT60",
          "buyer_po_num" => header["purchase_order_number"] || nil,
          "summary_buyer_order_ref" => header["purchase_order_number"] || nil,
          "market_buyer_order_ref" => nil,
          "destination_buyer_order_ref" => "Australia",
          "delivery_buyer_order_ref" => header["purchase_order_number"] || nil,
          "buyer_order_date" => header["po_create_date"] || nil,
          ...
          "market" => "Australia",
          "buyer_style_ref" => line_item["style_no"] || nil,
          "packing_type" => nil,
